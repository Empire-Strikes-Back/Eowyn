...
/**
 * Given a base url and a zipped file name downloads contents to a specified directory under ~/deeplearning4j-data
 ...
 *      unzip it to ~/deeplearning4j-data/data-dir
 *      and return the unzipped path ~/deeplearning4j-data/data-dir/DataExamples
 *
 */
public enum Downloader {
     ...
     * @param dataFolder The folder to extract to under ~/deeplearning4j-data
     * @param md5 of zipfile
     * @param dataSize of zipfile
     */
    Downloader(String zipFile, String dataFolder, String md5, String dataSize) {
     ...
     * @param dataSize of zipfile
     */
    Downloader(String baseURL, String zipFile, String dataFolder, String md5, String dataSize) {
        BASE_URL = baseURL;
    ...
    public String Download() throws Exception {
        ...
        String extractDir = FilenameUtils.concat(System.getProperty("user.home"), "deeplearning4j-data/" + DATA_FOLDER);
