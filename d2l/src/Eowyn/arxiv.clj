(ns Eowyn.arxiv
  (:require [clojure.reflect :refer [reflect]]
            ...
            [Elrond.prn.core :refer [linst]]
            [Elrond.coll.core :refer [contained?]]
            [Elrond.io.core :refer [read-nth-line count-lines]]
            [Elrond.core :refer [str-float? str>>float resolve-var]]
            [Elrond.math.core :refer [vec-standard-deviation-2
                                   scalar-subtract elwise-divide
                                   vec-mean scalar-divide
                                   mk-one-hot-vec std]]
            [Elrond.dataset.glove :refer [glove-filepath read-glove!]]
            [Elrond.dataset.arxiv :refer [categories>>data! data>>labeled
                                       data>>tokened tokened>>limited data>>embedded
                                       data>>padded fetch-arxiv-sample]]
            [Elrond.ml.nlp :refer [build-vocab]]
            [Elrond.dataset.bert :refer [read-vocab-json! fetch-bert-example fetch-bert-python] :as bert]
