(ns deeplearning4j.doc2vec-infer
  (:require [clojure.string :as string]
            [deeplearning4j.impl :refer [bash-ls]])
  (:import
   org.deeplearning4j.examples.download.Downloader
 ...
 #_(.Download Downloader/NLPDATA)
  ; "/root/deeplearning4j-data/dl4j-examples/nlp"

(comment

  (def data-local-path "/root/deeplearning4j-data/dl4j-examples/nlp")
