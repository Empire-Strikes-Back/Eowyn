(ns deeplearning4j.ui
  (:require [clojure.pprint :as pp]
            [clojure.java.io :as io]
            [clojure.java.shell :refer [sh]]
            [clojure.string :as string]
            [deeplearning4j.repl :refer [safe-deref-future]])
  (:import
   ...
   org.deeplearning4j.examples.userInterface.util.Mnist)
  (:gen-class))


(comment

  (def net (Mnist/getMnistNetwork))

  (def train-iter (Mnist/getMnistData))
